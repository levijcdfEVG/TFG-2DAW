<?php
    ...
    class cCentros {
        ...
        public function listaUsuarios(){
            $resultado = $this->objCentro->listaUsuarios();
        ...
        // ---------------------------VALIDACIONES---------------------------
           ...
           // Validar que la localidad coincida con el código postal
            ...
            $resultadoValidacion = $this->objCentro->validarDatosUsuarios($nombreCentro, $direccionCentro, $cpCentro, $localidadCentro, $telefonoCentro, $emailCentro);
            ...
            // --------------------------- FIN DE VALIDACIONES---------------------------
                $resultado = $this->objCentro->insertIntoUsuarios($nombreCentro, $direccionCentro, $cpCentro, $localidadCentro, $telefonoCentro, $emailCentro);
        ...
        public function modificarUsuario() {
            ...
            if (
                ...
                $resultado = $this->objCentro->modificarUsuario(
                    $emailReferencia,
                    $nombreCentro,
                    $direccionCentro,
                    $cpCentro,
        ...
        public function eliminarUsuario() {
            ...
            if (isset($inputData['emailReferencia'])) {
                ...
                $resultado = $this->objCentro->eliminarUsuario($emailReferencia);
